...
cat `grep -o '"[^"]*\.js"' public/index.php | sed 's/script.js/script.min.js/g;s/"//g;s/^/public/g'` > public/js/js.js
cat `grep -o '"[^"]*\.css"' public/index.php | sed 's/"//g;s/^/public/g'` > public/css/css.css
