 ...
 * 
 * Modified on 2015-12-30 by Marten Tacoma
 */
...
class GeoHash {
	...
	*/
	private function binEncode($number, $min, $max, $bitcount)
	{
		...
		return (($number>$mid) ? '1' : '0') . $this->binEncode($number, $mid, $max, $bitcount-1);
	}
	...
	*/
	private function binDecode($binary, $min, $max)
	{
		...
		return ($bit==1) ? $this->binDecode($binary, $mid, $max) : $this->binDecode($binary, $min, $mid);
	}
}